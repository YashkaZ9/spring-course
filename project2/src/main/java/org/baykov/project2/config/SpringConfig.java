package org.baykov.project2.config;
...
@Configuration
@ComponentScan("org.baykov.project2")
@EnableWebMvc
@EnableTransactionManagement
@EnableJpaRepositories("org.baykov.project2.repo")
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("org.baykov.project2.model");
